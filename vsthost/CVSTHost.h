...
#include "steinberg/audioeffectx.h"               /* VST header files                  */
...
#if defined(VST_2_4_EXTENSIONS)
#include "steinberg/aeffEditor.h"
#else
#include "steinberg/AEffEditor.hpp"
#endif
...
//#if defined(VST_2_4_EXTENSIONS) // commented by sqba
	static void SwapBytes(VstInt32 &vi);
//#endif // commented by sqba
